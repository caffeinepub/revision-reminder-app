...
export class Backend implements backendInterface {
    ...
    async addTopic(arg0: string): Promise<void> {
    ...
    async getDueReminders(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDueReminders();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudyProgress(): Promise<Array<[Time, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudyProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopics(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async markReminderDone(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markReminderDone(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
